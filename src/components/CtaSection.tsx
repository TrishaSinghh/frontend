...
const CtaSection = () => {
  return (
    <section className="py-16 bg-gradient-to-br from-[#3B82F6] to-[#3B82F6] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Ready to Build Your Professional Presence?</h2>
          <p className="text-xl mb-8 opacity-90">
            Join thousands of medical professionals already connecting, collaborating, and growing their careers.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Button size="lg" variant="secondary" className="bg-white text-[#3B82F6] hover:bg-gray-100">
                Get Started
              </Button>
            </motion.div>
            <motion.div
