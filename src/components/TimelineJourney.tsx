...
const TimelineJourney = () => {
  return (
    <section className="relative py-24 bg-gradient-to-br from-[#e0e7ef] via-[#f8fafc] to-[#e0e7ef] overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="flex items-center px-8 py-4 bg-white/80 backdrop-blur-lg rounded-full shadow-lg border border-[#3B82F6]/20">
            <motion.div
              className="w-4 h-4 mr-3 rounded-full bg-gradient-to-r from-[#3B82F6] to-[#38bdf8] shadow-lg"
              animate={{ scale: [1, 1.25, 1], opacity: [1, 0.7, 1] }}
              transition={{ duration: 1.6, repeat: Infinity }}
            />
            <span className="font-semibold text-lg text-[#1D4ED8]">
              Join over <span className="font-extrabold text-[#3B82F6]">500,000</span> medical professionals
            </span>
          </div>
        </motion.div>
      </div>
